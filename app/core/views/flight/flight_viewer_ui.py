...
class Ui_FlightViewerWindow(object):
    def setupUi(self, FlightViewerWindow):
        ...
        self.actionOpenRecording = QAction(FlightViewerWindow)
        self.actionOpenRecording.setObjectName(u"actionOpenRecording")
        ...
        self.menuMain.addSeparator()
        self.menuMain.addAction(self.actionOpenRecording)
        self.menuMain.addSeparator()
...
#endif // QT_CONFIG(tooltip)
        self.actionOpenRecording.setText(QCoreApplication.translate("FlightViewerWindow", u"Open Recording\u2026", None))
#if QT_CONFIG(tooltip)
        self.actionOpenRecording.setToolTip(QCoreApplication.translate("FlightViewerWindow", u"Watch a recording: video, detections, telemetry and map.", None))
#endif // QT_CONFIG(tooltip)
