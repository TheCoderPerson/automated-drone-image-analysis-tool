...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionRTMPMotionDetection = QAction(MainWindow)
        self.actionRTMPMotionDetection.setObjectName(u"actionRTMPMotionDetection")
        self.actionRTMPMotionDetection.setFont(font)
        self.actionChromaticAberrationRemoval = QAction(MainWindow)
        self.actionChromaticAberrationRemoval.setObjectName(u"actionChromaticAberrationRemoval")
        self.actionChromaticAberrationRemoval.setFont(font)
...
"color: rgb(228, 231, 235);")
        ...
        self.menuFile.addAction(self.actionChromaticAberrationRemoval)
        self.menuFile.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionChromaticAberrationRemoval.setText(QCoreApplication.translate("MainWindow", u"Chromatic Aberration Removal", None))
        ...
        self.actionRTMPMotionDetection.setText(QCoreApplication.translate("MainWindow", u"Real-Time Motion Detection", None))
