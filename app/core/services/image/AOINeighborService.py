...
class AOINeighborService:
    ...
    def gps_to_pixel(self, target_lat, target_lon, coverage_info):
        ...
        try:
            ...
            # The forward transformation uses adjusted_yaw = yaw + 180°
            # Original: north = -ground_offset_x * sin(adj_yaw) - ground_offset_y * cos(adj_yaw)
            #           east = ground_offset_x * cos(adj_yaw) - ground_offset_y * sin(adj_yaw)
