...
class AOIService:
    ...
    def estimate_aoi_gps(self, image, aoi, agl_override_m=None):
        ...
        try:
            ...
            # fx = width * (focal_mm / sensor_w_mm)  # Reserved for future use
            # fy = height * (focal_mm / sensor_h_mm)  # Reserved for future use
            cx, cy = width / 2.0, height / 2.0

            # --- Step 3: Get AOI position and calculate offsets ---
            u, v = aoi['center']
            # pixel_offset_x = u - cx  # Reserved for future use
            # pixel_offset_y = v - cy  # Reserved for future use
